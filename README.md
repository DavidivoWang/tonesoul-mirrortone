...
### 3) Run the session-start bundle
...
| AI Agent | [docs/AI_QUICKSTART.md](docs/AI_QUICKSTART.md) | `python scripts/start_agent_session.py --agent <your-id>` -> [AI_ONBOARDING.md](AI_ONBOARDING.md) -> [docs/foundation/README.md](docs/foundation/README.md) -> [task.md](task.md) | operational first hop first, session handshake second, routing map third, bounded packet fourth, short board fifth |
