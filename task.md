...
- Progress: **17 trials promoted, 1 parked** (as of 2026-04-08, by Codex)
  - Eighteenth candidate admitted. See `docs/plans/tonesoul_self_improvement_loop_v0_2026-04-06.md` and `docs/status/self_improvement_loop_latest.json`.
- Continue trial waves as new safe candidates emerge. Each trial follows the same admit→run→classify→register pattern; no need to list each one as a separate phase.
